                ...
                <div className="w-full md:w-[400px] bg-white p-8 flex flex-col gap-6 shrink-0">
                    ...
                    <div className="space-y-4">
                        ...
                        <input 
                            ...
                            className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 font-medium focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                    ...
                    <div className="space-y-2 flex-1 flex flex-col justify-center">
                        ...
                        >
                            ...
                            <div>
                                <p className={`font-bold text-sm ${accepted ? 'text-primary' : 'text-slate-700'}`}>
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-primary text-white rounded-xl font-bold text-lg hover:bg-primary/90 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                    >
