        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-full hidden md:flex items-center gap-2">
          {tabs.map(tab => (
            <button
              ...
              className={`relative h-full px-4 flex items-center gap-2 text-sm font-bold transition-colors ${activeTab === tab.name
                  ? 'text-slate-900'
        ...
        <div className="flex justify-between items-center h-16">
          {tabs.map(tab => (
            <button
              key={tab.name}
              onClick={() => setActiveTab(tab.name)}
              className={`flex flex-col items-center justify-center gap-1 w-full h-full transition-colors ${activeTab === tab.name
                  ? 'text-zambia-red'
