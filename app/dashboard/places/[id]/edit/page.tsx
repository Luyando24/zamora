...
import { ChevronLeft, Save, Loader2, Upload, MapPin, Store, Phone } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Edit Place</h1>
          <p className="text-slate-500">Update listing details</p>
        </div>
      </div>
