...
export default function BarOrdersPage() {
  ...
  const [orderToConfirmPOS, setOrderToConfirmPOS] = useState<string | null>(null);
  ...
  const updateStatus = async (orderId: string, newStatus: string, skipConfirm = false) => {
    if (newStatus === 'pos_completed' && !skipConfirm) {
      setOrderToConfirmPOS(orderId);
      return;
    }
            ...
            >
              <div className="p-8 text-center">
                ...
                <p className="text-slate-500 text-sm leading-relaxed mb-8">
                  Has this drink order been successfully added to the POS system? This will mark the order as fully completed.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    onClick={() => updateStatus(orderToConfirmPOS, 'pos_completed', true)}
