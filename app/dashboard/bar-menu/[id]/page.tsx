  ...
  if (!item) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/dashboard/bar-menu" className="text-zambia-green hover:underline mt-2 inline-block">
          Back to Bar Menu
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 py-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Bar Item</h1>
