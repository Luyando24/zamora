-- ==============================================================================
-- FIX: Create Missing Stock Tables (Snapshots & Recipes)
-- ==============================================================================
-- Run this script to ensure the necessary tables for the Stock module exist.

-- 1. Create Stock Snapshots Table
...
-- 2. Create Menu Item Recipes Table
...
-- 5. Policies (Drop first to avoid conflicts if they exist but table was missing somehow)
DROP POLICY IF EXISTS "Snapshots viewable by property members" ON stock_snapshots;
DROP POLICY IF EXISTS "Snapshots editable by managers" ON stock_snapshots;
DROP POLICY IF EXISTS "Recipes viewable by property members" ON menu_item_recipes;
DROP POLICY IF EXISTS "Recipes editable by managers" ON menu_item_recipes;
